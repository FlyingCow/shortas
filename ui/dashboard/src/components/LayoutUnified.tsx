            ...
            <div style={{ padding: 16, fontSize: '0.8125rem' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <tbody>
                  ...
                  <tr><td style={{ padding: '0.35rem 0.5rem 0.35rem 0' }}><kbd style={{ padding: '0.15rem 0.4rem', background: 'var(--bg-tertiary)', borderRadius: 4 }}>Alt</kbd> + <kbd style={{ padding: '0.15rem 0.4rem', background: 'var(--bg-tertiary)', borderRadius: 4 }}>R</kbd></td><td style={{ padding: '0.35rem 0' }}>Refresh (Dashboard)</td></tr>
                  <tr><td style={{ padding: '0.35rem 0.5rem 0.35rem 0' }}><kbd style={{ padding: '0.15rem 0.4rem', background: 'var(--bg-tertiary)', borderRadius: 4 }}>Ctrl</kbd> / <kbd style={{ padding: '0.15rem 0.4rem', background: 'var(--bg-tertiary)', borderRadius: 4 }}>Alt</kbd> + <kbd style={{ padding: '0.15rem 0.4rem', background: 'var(--bg-tertiary)', borderRadius: 4 }}>N</kbd></td><td style={{ padding: '0.35rem 0' }}>New route (Routes)</td></tr>
                  <tr><td colSpan={2} style={{ padding: '0.5rem 0 0.25rem 0', borderTop: '1px solid var(--border-primary)' }}></td></tr>
                  ...
                  <tr><td style={{ padding: '0.35rem 0.5rem 0.35rem 0' }}><kbd style={{ padding: '0.15rem 0.4rem', background: 'var(--bg-tertiary)', borderRadius: 4 }}>Enter</kbd></td><td style={{ padding: '0.35rem 0' }}>Confirm dialog</td></tr>
